...
<html>
    ...
    <body>
        <a href="#edit-agendaConsulta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-agendaConsulta" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.agendaConsulta}" method="PUT">
                <g:hiddenField name="version" value="${this.agendaConsulta?.version}" />
                <fieldset class="form">
